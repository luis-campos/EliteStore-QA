        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Discover our handpicked selection of premium products, carefully chosen for their exceptional quality and
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                All products are carefully tested and come with our quality guarantee.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Our customer support team is available 24/7 to help you.</p>
            </div>
          </div>
        </div>
      </section>
